	...
	<div class="col-lg-12">
		<div class="panel panel-default">
			...
			<div class="pannel-body">
				...
				<!-- 페이지 처리 -->
				<!-- 페이지 정보를 저장하는 form, 사용자한테 보여지지 않게 이 폼을 submit하면 pageNum에 맞는 페이지 보여주기 -->
	...
	$(document).ready(
			function() {
				...
				$(".paginate_button a").on("click",function(e){
					e.preventDefault();
					console.log("click");
					//페이지 정보 controller 에게 보내기
					//click한 a태그의 번호를 pageNum으로 해서 보낸다.
					//actionForm에서 name 속성이 pageNum인 input태그 찾기
					//input태그의 값을 현재 내가 클릭한 a href 값으로 바꿔주면 됌.
				...
				$(".move").on("click",function(e){
					...
					//게시글 제목 눌렀을 때 이벤트 처리
					e.preventDefault();
					// 페이지 정보 같이 전달 (게시물 조회 페이지에는 페이지 정보가 없다.)
					// 조회 페이지에서 리스트 페이지로 돌아오면 1페이지부터 시작하게 되어
					// 조회 페이지에서 페이지 정보를 알 수 있게
					// 기존에 a링크의 href에 글 번호를 붙여서 줬는데 여기서는 a링크 기본 클릭을 막았음
					// form을 보낼 때 게시글 번호 정보를 담아서 보내야 함
